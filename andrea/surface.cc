...
cout << "surface_parse " << tokens << endl;
   ...
   if (tokens[0] == "help")
   {
      ...
      cout << "---> surface sounding tephigram tokens" << endl;
      cout << "---> surface sounding chart surface_identifier sounding_identifier 0:100 z/0/12000 theta|speed|along_speed|brunt_vaisala|scorer" << endl;
